                ...
                <div>
                  <ul className="navbar-nav me-auto mb-2 mb-lg-0">
                    <li className="nav-item">
                      <a className="nav-link" href="/categories/1">
                        Alimentation
                      </a>
                    </li>
                    <li className="nav-item">
                      <a className="nav-link" href="/categories/2">
                        Bâtiment
                      </a>
                    </li>
                    <li className="nav-item">
                      <a className="nav-link" href="/categories/3">
                        Fabrication
                      </a>
                    </li>
                    <li className="nav-item">
                      <a className="nav-link" href="/categories/4">
                        Services
                      </a>
                    </li>
                  </ul>
