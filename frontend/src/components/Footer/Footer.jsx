...
const Footer = () => {
    return (
        <footer className=" text-white">
                ...
                <div className="container-lg pt-4">
                    ...
                    <div className="row mb-4">
                        ...
                        <div className="col-lg-8">
                            ...
                            <p>Ouvert du lundi au vendredi de <time dateTime="08:15">8h15</time> à <time datetime="17:00">17h</time></p>
                            <a  href="tel:+33(0)426734000" className="text-decoration-none text-reset">
                            ...
                            <p>Accueil téléphonique du lundi au vendredi de <time datetime="08:30">8h30</time> à <time datetime="17:00">17h</time></p>
                            <div className="d-flex align-items-center gap-2">
                                <img
            ...
            <div className="d-flex social-row justify-content-center m-3 column-gap-3" target="_blank" rel="noopener noreferrer">
